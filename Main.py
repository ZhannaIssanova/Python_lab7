...
from PyQt5.QtWidgets import QTableWidgetItem, QCheckBox, QAbstractItemView, QLineEdit
...
class Form2(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.label_img.setPixmap(QPixmap('images/kz.png'))
        ...
        self.checkBox.stateChanged.connect(self.checked1)
...
class Form3(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.label_img.setPixmap(QPixmap('images/study.png'))
        self.label_img.setScaledContents(True)
...
class Form4(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon('images/logo.png'))
        self.label_img.setPixmap(QPixmap('images/Univ.png'))
        self.label_img.setScaledContents(True)
...
class Form5(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.lineEdit.setText("Свое детство вы провели в: " + answers[0])
        self.lineEdit_2.setText("Вы учились в : " + answers[1])
        self.lineEdit_3.setText("У вас есть высшее образование : " + answers[2])
        self.btn_back.clicked.connect(self.back)
        self.btn_exit.clicked.connect(self.close)
